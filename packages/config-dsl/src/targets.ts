...
export const browser = {
  ...
  opera: makeBrowser("opera"),
  operaGx: makeBrowser("opera-gx"),
  dia: makeBrowser("dia"),
  atlas: makeBrowser("atlas"),
  comet: makeBrowser("comet"),
  zen: makeBrowser("zen"),
  orion: makeBrowser("orion"),
  duckduckgo: makeBrowser("duckduckgo"),
  librewolf: makeBrowser("librewolf"),
  waterfox: makeBrowser("waterfox"),
  floorp: makeBrowser("floorp"),
  mullvad: makeBrowser("mullvad-browser"),
  tor: makeBrowser("tor-browser"),
  yandex: makeBrowser("yandex"),
  whale: makeBrowser("whale"),
