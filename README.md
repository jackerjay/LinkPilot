...
Download the DMG that matches your Mac's architecture from the latest
GitHub release — Apple Silicon ships an `aarch64` build, Intel Macs use
`x86_64`. Copy `LinkPilot.app` to `/Applications`, then open it:
